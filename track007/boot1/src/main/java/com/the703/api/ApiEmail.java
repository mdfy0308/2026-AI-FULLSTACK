...
public class ApiEmail {
	...
	@Value("${naver.user}") private String user; // 계정 이메일
	...
	public void sendMail(String subject, String content, String to) {
		...
		try {
			message.setFrom(new InternetAddress(user)); // 보내는 사람 - mdfy0308@naver.com(관리자 이메일)
			...
			message.setContent(""
					...
					+ "<p style='font-size:12px; color:#888; text-align:center;'>이 메일은 자동 발송된 안내 메일입니다.<br>문의: <a href='mailto:mdfy0308@naver.com' style='color:#005bac; text-decoration:none;'>mdfy0308@naver.com</a></p>"
					+ "</div>"
...
//1. Naver - 이메일(로그인) - smtp.naver.com / mdfy0308@naver.com
//2. 2차보안 - 비밀번호 - 65GF5XEK69SM
//3. Service
//4. Controller
//5. view