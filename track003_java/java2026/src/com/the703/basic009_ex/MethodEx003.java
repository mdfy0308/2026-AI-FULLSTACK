...
public class MethodEx003 {
	...
	public static float return_float() { return (float)(10/3.0); }
	...
	public static String myban(char ban) { return ban == 'A'? "노랑조":"주황조"; }
	public static String stdId(int a) { return "G" + a; }
	public static char stdAvg(int num) { return num>=90? 'A':num>=80? 'B':num>=70? 'C':'D'; } 
