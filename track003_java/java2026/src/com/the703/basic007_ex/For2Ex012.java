...
//		sum = 0;
//		for(int i=1;i<=20;i++) { System.out.print(i + (i<20? "+":"=")); sum+=i; } System.out.print(sum); System.out.println();
//		sum = 0;
//		for(int i=1;i<=30;i++) { System.out.print(i + (i<30? "+":"=")); sum+=i; } System.out.print(sum); System.out.println();

		// 총정리
		System.out.println("ver 1) for");
		for(int j=10;j<=100;j+=10) {
			sum = 0;
			for(int i=1;i<=j;i++) { System.out.print(i + (i<j? "+":"=")); sum+=i; }
