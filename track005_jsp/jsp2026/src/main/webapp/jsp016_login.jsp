   ...
   <div class="container card  my-5">
      ...
      <form action="jsp016_result.jsp"  method="post"  onsubmit="return checkLogin()">
         ...
         <div class="my-3  text-end">
         	<% if(email == null){ %>
            <button type="submit"    title="login 하러가기" class="btn btn-primary"  id="check" name="remember"> 로그인 </button>
            <% } else { %>
            <a href="jsp016_logout.jsp" class="btn btn-primary"> 로그아웃</a>
            <% } %>
         </div>                        
      </form>
      <script>
      function  checkLogin(){
         ...
         if(bpass.value.trim()  == ""){  alert("비밀번호 칸을 확인해주세요"); bpass.focus(); return false; }
         return true;
      }
      </script>
   </div>
