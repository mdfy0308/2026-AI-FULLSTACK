...
<body>
	<div class="container card  p-3 my-3">
		...
		<pre class="alert alert-success">
			...
			2. 로그인에 성공시 - session.getAttribute() 서버측의 정보를 header에서 불러옴
			3. 로그아웃시 - session.invalidate()	    서버측의 정보를 삭제
		</pre>
		...
		<div class="text-center p-3">
			<a href="jsp015_session2.jsp" class="btn btn-danger">세션값 저장</a> <a
				href="jsp015_session3.jsp" class="btn btn-danger">세션값 삭제</a> <a
				href="jsp015_session4.jsp" class="btn btn-danger">세션값 초기화</a>
		</div>
	</div>
</body>
</html>