...
■1. 자바스크립트 빈칸채우기
1. 자바스크립트의 출력   (document.write("문자열"), console.log("문자열"))
2. 변수    (var, let, const)
3. 변수차이   (var는 전역, let은 지역, const는 상수)
4. 변수는 모든자료형을 담을수 있다.  자료형확인은 (typeof)

5. 알림창 종류  - (alert("알림창") prompt("질문") confirm("yes, no"))
...
■2. 자바
1.  OOP? 객체 지향 프로그래밍, 부품객체(클래스)를 조립해서 완성된 프로그램을 만드는 기법
