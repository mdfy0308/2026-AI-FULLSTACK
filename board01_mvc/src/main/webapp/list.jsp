		...
		<tbody>
			...
			try {
				...
				while (rset.next()) {
					...
					out.print("<tr><td>" + cnt-- + "</td><td><a style='text-decoration:none; color: inherit;' href='detail.jsp?bno="
					+ bno + "' title='상세보기'>" + rset.getString("btitle") + "</a></td>" + "<td>" + rset.getString("bname")
					+ "</td>" + "<td>" + rset.getTimestamp("bdate") + "</td>" + "<td>" + rset.getInt("bhit")
					+ "</td></tr>");
				}
