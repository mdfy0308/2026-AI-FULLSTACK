...
## 📌 성장 포인트
- 단순 기능 구현에서 **CS 기반 문제 해결**로 사고 확장
- 개인 학습 경험으로 시작해 **GitHub 협업 워크플로우**로 팀 개발 경험까지 체득 (브랜치 전략, Pull Request 경험)
- 이론 중심보다 **실습과 배포를 경험**하며 “끝까지 책임지는 개발자”로 성장
- 클라우드 경험을 지나 **AWS EC2 서버 운영 및 보안 그룹 설정**을 통한 실제 서비스 배포
